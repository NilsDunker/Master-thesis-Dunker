...
class Simulations:
    ...
    def assign_nodes_to_political_activity(self, is_pa, anticipated_sea_level_rise, node_elevation, network,
                                           number_of_nodes):
        """Nodes are assigned to different political activities.
        This could be potentially acitve, certainly active, certainly inactive, or contingetly active(influenceable_nodes)"""
    ...
    def calculate_geographical_node_positions(self, network, node_alts):
        """This function is used to calculate the minimum distnace to the coast for every node."""
