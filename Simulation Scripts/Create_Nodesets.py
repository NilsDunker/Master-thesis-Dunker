...
def create_nodesets(number_of_nodes, number_of_nodesets, first_nodeset_index, population_folder=None, nodesets_folder=None):
    """This function is used to create a nodeset where the nodes are distributed according to real population densities.
    Only the node position is created and no network."""
